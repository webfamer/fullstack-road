...
> 来源：https://www.yuque.com/xiumubai/doc/mr7cns8g8lcduquh
...
![](/api/filetransfer/images?url=https%3A%2F%2Fstatic.vue-js.com%2F052904c0-cd89-11eb-ab90-d9ae814b240d.png&sign=57f356570a01b0770bf989ebe59d958d8050214a1353013a6b327d8adc9df288)
...
![](/api/filetransfer/images?url=https%3A%2F%2Fstatic.vue-js.com%2F1175f990-cd89-11eb-85f6-6fac77c0c9b3.png&sign=99110ea0ff3fb2a8182fd95275c6ff13a61a44fdb55ed97ac1ae88a85eb52f55)

header

每个JWT都会带有头部信息，这里主要声明使用的算法。声明算法的字段名为alg，同时还有一个typ的字段，默认JWT即可。以下示例中算法为HS256

​91{  "alg": "HS256",  "typ": "JWT" }
...
​JavaScriptRun CodeCopy912345router.get('/api/userInfo',async (ctx,next) =>{    const authorization =  ctx.header.authorization // 获取jwt    const token = authorization.replace('Beraer ','')    const result = jwt.verify(token,'test_token')    ctx.body = result
...
●[https://blog.wangjunfeng.com/post/golang-jwt/](https://blog.wangjunfeng.com/post/golang-jwt/)
