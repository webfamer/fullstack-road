...
> 来源：https://www.yuque.com/xiumubai/doc/cn1hrb8gsgdbpevr
...
![](/api/filetransfer/images?url=https%3A%2F%2Fstatic.vue-js.com%2Faec05670-c76f-11eb-ab90-d9ae814b240d.png&sign=370f7a549846178ec0c4ccbf7b8016dcbc6f444654051b88c04f55cdcd9a4911)
...
![](/api/filetransfer/images?url=https%3A%2F%2Fstatic.vue-js.com%2Fb7ac6d00-c76f-11eb-ab90-d9ae814b240d.png&sign=b73314841b1ff7be0431fa9de4a0404fef73667269dee213a001e667f81e63bc)
...
![](/api/filetransfer/images?url=https%3A%2F%2Fstatic.vue-js.com%2Fc02883b0-c76f-11eb-ab90-d9ae814b240d.png&sign=6dfcef7896acd2366e3ec6e04c966daca2b19ae25986d0b54e77e882d0d8dae0)
...
​JavaScriptRun CodeCopy9123456789const server = http.createServer(function (req, res) {    const method = req.method; // 获取请求方法    if (method === 'GET') { // get 请求        const fileName = path.resolve(__dirname, 'data.txt');        let stream = fs.createReadStream(fileName);        stream.pipe(res); // 将 res 作为 stream 的 dest    }});server.listen(8000);
文件操作

创建一个可读数据流readStream，一个可写数据流writeStream，通过pipe管道把数据流转过去

​JavaScriptRun CodeCopy9912345678910111213141516const fs = require('fs')const path = require('path')
