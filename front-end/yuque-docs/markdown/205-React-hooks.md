...
> 来源：https://www.yuque.com/xiumubai/doc/ktik9wicz0ipvsna
...
​99123456789101112131415import React, { useState } from 'react';
...
​9912345678910111213141516171819class Example extends React.Component {  constructor(props) {    super(props);    this.state = {      count: 0    };  }
...
​JSXCopy9912345678910useEffect(() => {    function handleStatusChange(status) {        setIsOnline(status.isOnline);    }
...
●[https://zh-hans.reactjs.org/docs/hooks-state.html](https://zh-hans.reactjs.org/docs/hooks-state.html)
●[https://zh-hans.reactjs.org/docs/hooks-effect.html](https://zh-hans.reactjs.org/docs/hooks-effect.html)
●[https://www.cnblogs.com/lalalagq/p/9898531.html](https://www.cnblogs.com/lalalagq/p/9898531.html)
