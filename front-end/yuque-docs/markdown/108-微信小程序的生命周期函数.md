...
> 来源：https://www.yuque.com/xiumubai/doc/qrg86rruglarl7h5
...
​JavaScriptRun CodeCopy9912345678910Component({  pageLifetimes: {    show: function() {      // 页面被展示    },    hide: function() {      // 页面被隐藏    },  }})
三、执行过程
