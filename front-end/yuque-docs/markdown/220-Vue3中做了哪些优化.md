...
> 来源：https://www.yuque.com/xiumubai/doc/xy17xnwkxkt45zfy
...
![](/api/filetransfer/images?url=https%3A%2F%2Fstatic.vue-js.com%2Fd7c32520-5c58-11eb-ab90-d9ae814b240d.png&sign=c5ef610532159eceda4247918e40c0c487685dc68c6ecd39dca86c5be6a3b522)
...
​JavaScriptRun CodeCopy9912345678910111213141516import { toRefs, reactive, onUnmounted, onMounted } from 'vue';function useMouse(){    const state = reactive({x:0,y:0});    const update = e=>{        state.x = e.pageX;        state.y = e.pageY;    }    onMounted(()=>{        window.addEventListener('mousemove',update);    })    onUnmounted(()=>{        window.removeEventListener('mousemove',update);    })
    return toRefs(state);}
组件使用

​JavaScriptRun CodeCopy91234567import useMousePosition from './mouse'export default {    setup() {        const { x, y } = useMousePosition()        return { x, y }    }}
