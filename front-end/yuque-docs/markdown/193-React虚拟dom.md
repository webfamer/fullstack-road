...
> 来源：https://www.yuque.com/xiumubai/doc/koppgxgp2iikzfsa
...
![](/api/filetransfer/images?url=https%3A%2F%2Fstatic.vue-js.com%2Ffc7ba8d0-d302-11eb-85f6-6fac77c0c9b3.png&sign=be1f1a8e9fbba63df21c507937b2d68d6b128e04f78141db3261c0b7b2971b34)
...
​9123456// 创建 h1 标签，右边千万不能加引号const vDom = <h1>Hello World</h1>; // 找到 <div id="root"></div> 节点const root = document.getElementById("root"); // 把创建的 h1 标签渲染到 root 节点上ReactDOM.render(vDom, root);
上述中，ReactDOM.render() 用于将你创建好的虚拟 DOM 节点插入到某个真实节点上，并渲染到页面上

JSX 实际是一种语法糖，在使用过程中会被 babel 进行编译转化成 JS 代码，上述 VDOM 转化为如下：

​912345const vDom = React.createElement(  'h1'，  { className: 'hClass', id: 'hId' },  'hello world')
...
![](/api/filetransfer/images?url=https%3A%2F%2Fstatic.vue-js.com%2F1716b9a0-d303-11eb-ab90-d9ae814b240d.png&sign=adaf86d021acf84cf5cea6aca495009401ec3819f800d326910fb0ed6ccd9a65)
