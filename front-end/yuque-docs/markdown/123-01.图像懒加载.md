...
> 来源：https://www.yuque.com/xiumubai/doc/arm74mt2u7k6oq4s
...
1监听 onscroll 事件，通过 getBoundingClientRect API 获取元素图片距离视口顶部的距离，配合当前可视区域的位置实现图片的懒加载
2通过 HTML5 的 IntersectionObserver API，[Intersection Observer（交叉观察器）](https://link.juejin.cn/?target=https%3A%2F%2Fweb.dev%2Flazy-loading-images%2F%23images-inline-intersection-observer) 配合监听元素的 isIntersecting 属性，判断元素是否在可视区内，能够实现比监听 onscroll 性能更佳的图片懒加载方案
...
假设我们有这样一个 DEMO：
​99123456789101112131415<div class="g-wrap">  // 模块 1  <div class="paragraph">    <p>Lorem Start!</p>       <img src="https://s1.ax1x.com/2023/02/20/pSX1xMV.png" alt="" />    <p>Lorem End!</p>    </div>  // 模块 2  <div class="paragraph">    <p>Lorem Start!</p>       <img src="https://s1.ax1x.com/2023/02/20/pSX1xMV.png" alt="" />    <p>Lorem End!</p>    </div>  // ... 连续几十个上述类似的结构</div>只需要给需要延迟（实时）渲染的元素，设置简单的 CSS 样式：
我们来看一下，设置了 content-visibility: auto 与没设置的区别。
如果，不添加上述的 content-visibility: auto 代码，页面的滚动条及滚动效果如下：
![](https://cdn.nlark.com/yuque/0/2023/webp/311219/1693905591238-54fd1586-82b6-427f-ad85-8bb449ff84f9.webp?date=1780734407322)
那么，在添加了 content-visibility: auto 之后，注意观察页面的滚动条及滚动效果：
![](https://cdn.nlark.com/yuque/0/2023/webp/311219/1693905591172-7863f49e-d5e5-4a65-a8be-ca80563e4516.webp?date=1780734407315)
...
因此，这也得到了一个非常重要的结论：
content-visibility: auto无法直接替代图片懒加载，设置了 content-visibility: auto 的元素在可视区外只是未被渲染，但是其中的静态资源仍旧会在页面初始化的时候被全部加载。因此，它更像是一个虚拟列表的替代方案。
...
![](https://cdn.nlark.com/yuque/0/2023/webp/311219/1693905591208-1e29c8e6-197d-4c72-9a50-231bd7ea787b.webp?x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_39%2Ctext_5pyI5ZOl55qE6Z2i6K-V6K6t57uD6JCl%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10)
...
![](https://cdn.nlark.com/yuque/0/2023/webp/311219/1693905591249-0e556af9-119e-4765-a338-c76112c9472b.webp?x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_39%2Ctext_5pyI5ZOl55qE6Z2i6K-V6K6t57uD6JCl%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10)
...
![](https://cdn.nlark.com/yuque/0/2023/webp/311219/1693905591205-d8eb326b-91de-46a7-83c7-c41c60ef3ce8.webp?x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_31%2Ctext_5pyI5ZOl55qE6Z2i6K-V6K6t57uD6JCl%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10)
...
看看效果：
![](https://cdn.nlark.com/yuque/0/2023/webp/311219/1693905591815-c1b083d3-dbbb-42da-a2e6-4c2e471072c4.webp?x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_30%2Ctext_5pyI5ZOl55qE6Z2i6K-V6K6t57uD6JCl%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10)
